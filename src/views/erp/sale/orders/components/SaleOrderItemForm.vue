...
<!--      </el-table-column>-->
      ...
      <el-table-column label="出货批发单价"  min-width="80">
        <template #default="{ row }">
          <el-form-item class="mb-0px!">
            <el-input disabled v-model="row.wholesaleProductPrice" />
          </el-form-item>
        </template>
      </el-table-column>
      ...
      <el-table-column label="原表数量"  min-width="80">
        <template #default="{ row }">
          <el-form-item class="mb-0px!">
            <el-input disabled v-model="row.productQuantity" />
          </el-form-item>
        </template>
      </el-table-column>
      ...
      <el-table-column label="货拉拉费用" prop="hulalaFee" fixed="right" min-width="140">
        <template #default="{ row, $index }">
