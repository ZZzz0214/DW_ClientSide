<template>
  <Dialog v-model="dialogVisible" title="销售价格导入" width="400">
    <el-upload
      ref="uploadRef"
...
import * as SalePriceApi from '@/api/erp/sale/saleprice'

defineOptions({ name: 'SalePriceImportForm' })
...
const uploadRef = ref()
const importUrl = import.meta.env.VITE_BASE_URL + import.meta.env.VITE_API_URL + '/erp/sale-price/import'
const uploadHeaders = ref() // 上传 Header 头
const fileList = ref([]) // 文件列表
const updateSupport = ref(0) // 是否更新已经存在的销售价格数据
