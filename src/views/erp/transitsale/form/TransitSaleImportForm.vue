<template>
  <Dialog v-model="dialogVisible" title="中转销售导入" width="400">
    <el-upload
      ref="uploadRef"
...
import * as TransitSaleApi from '@/api/erp/transitsale'

defineOptions({ name: 'TransitSaleImportForm' })
...
const uploadRef = ref()
const importUrl = import.meta.env.VITE_BASE_URL + import.meta.env.VITE_API_URL + '/erp/transit-sale/import'
