<template>
  <div class="copy-data-container">
    ...
    <div class="copy-data-content" ref="copyDataRef">
      ...
      <template v-else>
        <div class="data-item">
          <span class="field-name">产品编号：</span>
        ...
        <div class="data-item">
          <span class="field-name">产品简称：</span>
          <span class="field-value">{{ formData.productShortName || '-' }}</span>
        </div>
        <div class="data-item">
        ...
        <div class="data-item">
          ...
          <span class="field-value">{{ formData.standard || '-' }}</span>
        </div>
        <div class="data-item">
        ...
        <div class="data-item">
          ...
          <span class="field-value">{{ formData.barCode || '-' }}</span>
        </div>
        <div class="data-item">
        ...
        <div class="data-item">
          ...
          <span class="field-value">{{ getCartonDimensionsRaw() || '-' }}</span>
        </div>
        <div class="data-item">
          <span class="field-name">箱规重量：</span>
          <span class="field-value">{{ formData.cartonWeight || '-' }}</span>
        </div>
      </template>
    </div>
  </div>
