<template>
  <Dialog v-model="dialogVisible" title="批发采购审核导入" width="400">
    <el-upload
      ref="uploadRef"
...
const uploadRef = ref()
const importUrl =
  import.meta.env.VITE_BASE_URL + import.meta.env.VITE_API_URL + '/erp/wholesale/import-purchase-audit'
const uploadHeaders = ref() // 上传 Header 头
const fileList = ref([]) // 文件列表
const updateSupport = ref(0) // 是否更新已经存在的批发采购审核数据
