...
import type { ErpLiveBroadcastingRespVO } from '@/api/erp/liveBroadcasting'
import { RichTextWithUpload } from '@/components/RichTextWithUpload'

defineOptions({ name: 'ErpLiveBroadcastingMaterialForm' })

const props = defineProps({
  propFormData: {
    type: Object as PropType<ErpLiveBroadcastingRespVO>,
    default: () => {}
  },
