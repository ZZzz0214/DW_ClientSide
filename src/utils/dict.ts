...
export const DICT_TYPE = {
  ...
  // ========== ERP - 私播信息专用字典 ==========
  ERP_PRIVATE_CUSTOMER_POSITION: 'erp_private_customer_position', // ERP 私播信息客户职位
  ERP_PRIVATE_PLATFORM_NAME: 'erp_private_platform_name', // ERP 私播信息平台名称
  ERP_PRIVATE_CUSTOMER_ATTRIBUTE: 'erp_private_customer_attribute', // ERP 私播信息客户属性
  ERP_PRIVATE_CUSTOMER_CITY: 'erp_private_customer_city', // ERP 私播信息客户城市
  ERP_PRIVATE_CUSTOMER_DISTRICT: 'erp_private_customer_district', // ERP 私播信息客户区县
  ...
  // 直播信息相关字典
  ERP_LIVE_CUSTOMER_POSITION: 'erp_live_customer_position', // 直播客户职位
  ERP_LIVE_PLATFORM_NAME: 'erp_live_platform_name', // 直播平台名称
